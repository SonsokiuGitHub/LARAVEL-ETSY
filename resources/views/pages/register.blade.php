...
<body>
            ...
            <div class="header__button-control">
                <ul class="list__button-control d-flex align-items-center fw-bolder">
                    <li class="button-control--login">
                        <a class="d-inline-flex text-decoration-none" href="{{route('signin')}}">
                            ...
                            <div class="login-main-top">
                                <div class="login-main-top-wrapper">
                                    <div class="login-main-top__heading">
                                        ...
                                        <p class="">Registration is easy.</p>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="input__element--large effect-hover-input w-100" name="firstname" rules="required" type="text">
                                        <span class="form-message"></span>
                                    </div>
                                    <div class="form-group">
                                        <label for="">Passwork
                                    ...
                                    <div class="login-main-top__submit">
                                        <button type="submit" class="btn-etsy-main btn-hover-effect-main bg-btn-main w-100">
                                            Register
                                        </button>
                                    </div>
                                </div>
    ...
    <script type="module" src="../../assets/scripts/js-page/js-login/main.js"></script>
