    ...
    <div id="wrapper" class="container-fluid g-0">
        <header id="header" class="header">
            ...
            <div class="header__form-search">
                <button class="button-menu--mobile-tablet btn-etsy-main btn-hover-effect-sub">
                    <span>
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"
                            focusable="false">
                            <path d="M20,7H4C3.4,7,3,6.6,3,6s0.4-1,1-1h16c0.6,0,1,0.4,1,1S20.6,7,20,7z"></path>
                            <path d="M15.2,13H4c-0.6,0-1-0.4-1-1s0.4-1,1-1h11.2c0.6,0,1,0.4,1,1S15.8,13,15.2,13z">
                            </path>
                ...
                <div class="wrapper__form-search">
                    <form action="" class="">
                        <input class="header__input-search" type="text" placeholder="Search for anything">
            ...
            <div class="header__button-control">
                <ul class="list__button-control d-flex align-items-center fw-bolder">
                    <li class="button-control--sign-in">
                        <a href="../Page__Login-sign-in/index.html" class="text-decoration-none d-inline-block">
                            <button class="btn-etsy-main--small btn-hover-effect-sub text-caption-13 fw-bold">
                                <span>Sign in</span>
                            </button>
                        </a>
                    </li>
                    <li class="button-control--cart">
                        <a href="" class="text-decoration-none d-inline-block btn-etsy-main btn-hover-effect-sub">
                            <span>
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true"
                                    focusable="false">
        ...
        <footer id="footer">
            <div class="footer__background-shape">
                <span>
                    <svg xmlns="http://www.w3.org/2000/svg" class="" viewBox="0 0 1280 30"
            ...
            <div class="footer-top">
                <div class="footer-top__wrapper">
                    <h2>Yes! Send me exclusive offers, unique gift ideas, and personalized tips for shopping and
                        selling on Etsy.</h2>
                    <form action="">
                        <div style="max-width:480px; margin:0 auto;width:100%;">
                            <div class="form-group d-flex w-100">
                                <input type="text" placeholder="Enter your email">
                                <button class="btn-sub-email">Subscribe</button>
            ...
            <div class="footer-main">
                <div class="footer-main__top">
                    <span class="footer-main__top-background">
                    ...
                    <div class="footer-main__top-content d-flex align-items-center justify-content-center">
                        <div class="top-content flex-column flex-md-row">
                            <span class="top-content__icon">
                            ...
                            <div class="top-content__describe tooltip-trigger-underline">
                        ...
                        <div class="top-content-detail">
                            ...
                            centers that host Etsy.com, the Sell on Etsy app, and the Etsy app, as well as the
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-3">
                            <div class="box-content-infor">
                                ...
                                <div class="download-app-and-social-network">
                                    <a href="" class="download-app__link">
                                        <span>
                                    ...
                                    <ul class="social-network">
                                        <li class="social-network__item"><a href=""><i class="fab fa-facebook"></i></a>
                                        </li>
                                        <li class="social-network__item"><a href=""><i class="fab fa-instagram"></i></a>
                                        </li>
                                        <li class="social-network__item"><a href=""><i class="fab fa-twitter"></i></a>
                                        </li>
                                        <li class="social-network__item"><a href=""><i class="fab fa-youtube"></i>
                                        </li>
                                    </ul>
                                </div>
                            </div>
            ...
            <div class="footer-bottom">
                <div class="footer-bottom__left">
                    <button class="btn-change-language">
                        ...
                        <div class="infor-language">
                            <span> &nbsp;Vietnam &nbsp;|&nbsp; English(US)&nbsp;|&nbsp;$(USD) </span>
                        </div>
                    </button>
                </div>
                <div class="footer-bottom__right">
                   <span class="footer-license">© 2021 Etsy, Inc.</span>
                    <ul>
