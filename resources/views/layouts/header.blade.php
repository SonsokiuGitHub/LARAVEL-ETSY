                    ...
                    <form action="" class="">
                        <div class="position-relative w-100 d-block" >
                            <div class="input-group" aria-expanded="false">
                                <input class="header__input-search" type="text" name="keyword" autocomplete="off" placeholder="Search for anything">
            ...
            <div class="header__button-control">
                <ul class="list__button-control d-flex align-items-center fw-bolder">
                    <li class="button-control--sign-in">
                        <a href="{{route('signin')}}" class="text-decoration-none d-inline-block">
