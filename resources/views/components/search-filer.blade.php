...
<div class="box-search-filter">
    ...
    <div class="box-search-filter__main">
        <div class="filter__category">
            <ul class="filter__category-list">
                ...
                <li class="ps-4 fw-bolder"><a href="">
    ...
    <div class="box-search-filter__btn-bottom">
        <button class="btn-bottom--cancel">Cancel</button>
        <button class="btn-bottom--apply">Apply</button>
    </div>
    <button class="btn-close_box-search-filter">
        <span>
